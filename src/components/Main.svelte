  ...
  let steps = [
    {
      ...
      description:
        "I created this Website using MERN stack, which includes Freelancing and Providing communication between Job seekers and Hirers.",
    },
    {
      name: "Keep-Fit Session",
      icon: "fa-solid fa-list-check",
      description:
        "This landing website was created using React.js The webpage is fully responsive. It sells fitness program for Clients who can login and purchase.",
    },
    {
      name: "Motor-Cycle Service",
...
<main class="flex flex-col flex-1 p-4">
  ...
  >
    ...
    >
      <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
        Hi! I'm <span class="poppins text-violet-400">Dhanushwaran&nbsp;</span
        >AJ
        <br />Front-End
  ...
  <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
    ...
    <a
      href="https://github.com/dhanushwaran06"
      target="_blank"
    ...
    >
      <i class="fa-github fa-github" />
      <p>GitHub</p>
    </a>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
      <Step step={steps[0]}>
        <p>
          I created this Website using MERN stack, which includes Freelancing
          and Providing communication between Job seekers and Hirers.
        </p>
        <strong class="text-violet-400"
          >[ React.JS, Sass, Node.JS + Express, MongoDB ]</strong
        >
      </Step>
      <Step step={steps[1]}>
        <p>
          This landing website was created using React.js The webpage is fully
          responsive. It sells fitness program for Clients who can login and
          purchase.
        </p>
        <strong class="text-violet-400">[ React.JS, Framer-motion, email.js + mongoDB ]</strong>
      </Step>
      <Step step={steps[2]}>
        <p>
